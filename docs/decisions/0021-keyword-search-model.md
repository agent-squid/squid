...
`.user-ctx`, `<script>`, and `<style>` elements. Inline and fenced code are
included because they are part of the indexed assistant content; every result
should visibly show why it matched. Matches are wrapped in

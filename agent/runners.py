...
from .config import CLAUDE_PATH, CODEX_PATH, COPILOT_PATH, CURSOR_PATH, GROK_PATH, FIRST_BYTE_TIMEOUT, RESPONSE_TIMEOUT
...
async def run_auto(
    ...
    """Try claude → cursor → grok → codex → copilot in order of availability."""
    if CLAUDE_PATH:
        ...
        raise CLINotFoundError("No AI CLI found in PATH (claude, cursor-agent, grok, codex, or copilot)")
